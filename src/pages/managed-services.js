...
const ManagedServicesPage = () => {
  ...
  ReactGA.pageview('/managed-services');
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://omniralmedia.com/managed-services" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Omniral Media LLC | web design & development" />
        <meta property="og:url" content="https://omniralmedia.com/managed-services" />
